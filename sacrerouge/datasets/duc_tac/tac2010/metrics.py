...
def main(eval_tar, aesop_tar, output_dir):
    ...
    rouge = load_rouge_output(eval_tar, 'GuidedSumm2010_eval/ROUGE/rouge_A.m.out', 'GuidedSumm2010_eval/ROUGE/rouge_B.m.out')
    rouge_jk = load_rouge_jk_output(eval_tar, 'GuidedSumm2010_eval/ROUGE/rougejk_A.m.out', 'GuidedSumm2010_eval/ROUGE/rougejk_B.m.out')
    be = load_rouge_output(eval_tar, 'GuidedSumm2010_eval/BE/simple_A.m.hm.out', 'GuidedSumm2010_eval/BE/simple_B.m.hm.out')
    be_jk = load_rouge_jk_output(eval_tar, 'GuidedSumm2010_eval/BE/simplejk_A.m.hm.out', 'GuidedSumm2010_eval/BE/simplejk_B.m.hm.out')
