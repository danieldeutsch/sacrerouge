...
_summaries_file_path = 'datasets/duc-tac/duc2006/v1.0/task1.summaries.jsonl'
_metrics_file_path = 'datasets/duc-tac/duc2006/v1.0/task1.metrics.jsonl'


class TestDUC2006Rouge(unittest.TestCase):
    ...
    @pytest.mark.skipif(not os.path.exists(_summaries_file_path), reason='DUC 2006 task 1 summaries file does not exist')
    @pytest.mark.skipif(not os.path.exists(_metrics_file_path), reason='DUC 2006 task 1 metrics file does not exist')
    def test_rouge(self):
        # Test the first several instances in the DUC 2006 data to ensure that
