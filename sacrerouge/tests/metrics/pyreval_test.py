...
class TestPyrEval(ReferenceBasedMetricTestCase):
    def test_pyreval(self):
        ...
        # The method is way too slow to run it on all of the data, so we only run it on 2 examples. The expected output
        # for the rest is below:
        ...
        super().assert_expected_output(metric, expected_output, num_summaries=2)
