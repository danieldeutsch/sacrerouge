...
class TestRouge(unittest.TestCase):
    ...
    def test_hong2014(self):
        ...
        metrics, _ = rouge.score_all(centroid, duc2004)
        ...
        metrics, _ = rouge.score_all(classy04, duc2004)
        ...
        metrics, _ = rouge.score_all(classy11, duc2004)
        ...
        metrics, _ = rouge.score_all(dpp, duc2004)
        ...
        metrics, _ = rouge.score_all(freq_sum, duc2004)
        ...
        metrics, _ = rouge.score_all(greedy_kl, duc2004)
        ...
        metrics, _ = rouge.score_all(icsi_summ, duc2004)
        ...
        metrics, _ = rouge.score_all(lexrank, duc2004)
        ...
        metrics, _ = rouge.score_all(occams_v, duc2004)
        ...
        metrics, _ = rouge.score_all(reg_sum, duc2004)
        ...
        metrics, _ = rouge.score_all(submodular, duc2004)
        ...
        metrics, _ = rouge.score_all(ts_sum, duc2004)
